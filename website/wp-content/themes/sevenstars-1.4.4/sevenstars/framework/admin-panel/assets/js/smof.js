...
/* Add new sidebar */
	...
	*/
    ...
    jQuery('#reset_color_options').click(function(){
    	var reset_confirm = confirm('Reset Color Options');
    	if( reset_confirm ){
    		$('.ajax-loading-img').fadeIn();
    		jQuery.post( ajaxurl, {'action': 'reset_theme_color_options' }, function(data){
