...
function post_images_box() {
                ...
                if ( $attachments )
                    foreach ( $attachments as $attachment_id ) {
                        echo '<li class="image" data-attachment_id="' . $attachment_id . '">
                            ...
                            <ul class="actions">
                                <li><a href="#" class="delete" title="' . __('Delete image', 'sevenstars') . '">' . __('Delete', 'sevenstars') . '</a></li>
                            </ul>
                        </li>';
                    }
            ?>
    ...
    <p class="add_post_images hide-if-no-js">
        <a href="#"><?php _e('Add post gallery images', 'sevenstars'); ?></a>
    </p>
    <?php
}
...
function post_add_meta_boxes(){
    global $post;
    add_meta_box( 'post-images', __('Post Gallery', 'sevenstars'), 'post_images_box', 'post', 'side' );
}
