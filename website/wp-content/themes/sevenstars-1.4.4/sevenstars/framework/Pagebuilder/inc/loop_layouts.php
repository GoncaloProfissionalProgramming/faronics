...
function hover_featured_image(array $options = array()) {
    ...
    if( in_array($options['overlay'], array('permalink', 'both')) ){
        $icon_link = '<div class="hover-icon"><a href="'. permalink() .'" title="" class=""><i class="glyphicon glyphicon-link"></i></a></div>';
    }
    if( in_array($options['overlay'], array('lightbox', 'both')) ){
        $icon_popup = '<div class="hover-icon"><a href="'. $popup_link .'" rel="prettyPhoto" title=""><i class="glyphicon glyphicon-resize-full"></i></a></div>';
    }
