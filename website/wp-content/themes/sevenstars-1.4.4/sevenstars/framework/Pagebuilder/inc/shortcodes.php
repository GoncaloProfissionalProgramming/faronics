...
blox_shortcode( 'element_title', 'element_title_hook' );
...
blox_shortcode( 'blox_dropcap', 'blox_dropcap_hook' );
...
blox_shortcode( 'blox_highlight', 'blox_highlight_hook' );
...
blox_shortcode( 'blox_icon', 'blox_icon_hook' );
...
blox_shortcode( 'blox_tooltip', 'blox_tooltip_hook' );
