...
var carousel_row_attrs = ['post_type', 'category', 'count', 'ratio', 'slideseconds', 'extra_class', 'visibility'];
    ...
    jQuery('.carousel_fullwidth').each(function(){
        ...
        .click(function(){
            ...
            var ajax_params = {
                ...
                'slideseconds': $this.attr('slideseconds'),
            ...
            show_blox_form_ajax("Edit Carousel Element", ajax_params, function(){
                ...
                $this.attr('slideseconds', jQuery('#blox_option_slideseconds').val() );
