...
blox_shortcode( 'blox_testimonial', 'blox_testimonial_hook' );
    ...
    return '<div class="testimonial_item">
                ...
                <div class="testy_meta">
                    ...
                    <span class="testy_actions">
                        <a href="javascript:;" class="testy_prev"><i class="fa-chevron-left"></i></a>
                        <a href="javascript:;" class="testy_next"><i class="fa-chevron-right"></i></a>
                    </span>
                    <div class="clearfix"></div>
                </div>
            </div>';
}
blox_shortcode( 'blox_testimonial_item', 'blox_testimonial_item_hook' );
