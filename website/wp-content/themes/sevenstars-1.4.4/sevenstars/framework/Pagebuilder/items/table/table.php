...
function blox_parse_table_hook($atts, $content = null) {
    ...
    return '<div class="row blox_elem_price_table ' . $extra_class.'" data-animate="'. $animation .'" data-skin="'. $skin .'" data-button-icon="'.$button_icon.'">' . do_shortcode($content) . '</div>';
}

blox_shortcode('blox_table', 'blox_parse_table_hook');
...
blox_shortcode('blox_table_row', 'blox_parse_table_row_hook');
...
blox_shortcode('blox_table_cell', 'blox_parse_table_cell_hook');
?>