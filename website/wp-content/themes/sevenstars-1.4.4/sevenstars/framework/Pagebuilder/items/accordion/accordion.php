...
blox_shortcode( 'blox_accordion', 'blox_parse_accordion_hook' );
...
function blox_parse_accordion_item_hook( $atts, $content=null ) {
	...
	return '<div class="panel1 panel-default">
...
blox_shortcode( 'blox_accordion_item', 'blox_parse_accordion_item_hook' );
