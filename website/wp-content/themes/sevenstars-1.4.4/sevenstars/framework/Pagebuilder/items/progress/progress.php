...
function blox_parse_progress_hook($atts, $content = null) {
    ...
    $result = "<div class='progress-wrap $is_animate $extra_class $visibility' data-animate='$animation'>
                    <div class='bar-text'>
                        <span>$title:</span>
                    ...
                    <div class='progress $striped $active'>
                        <div class='progress-bar $type' role='progressbar' aria-valuenow='".(int)$percent."' aria-valuemin='0' aria-valuemax='100' style='width: ".(int)$percent."%;'>
                            <span class='sr-only'>".(int)$percent."% ".__('Complete', 'sevenstars')."</span>
                        </div>
                    </div>
                </div>";
...
blox_shortcode('blox_progress', 'blox_parse_progress_hook');
?>