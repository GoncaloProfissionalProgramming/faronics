...
class tt_IconBoxWidget extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('icon'); ?>"><?php _e("Icon:", 'sevenstars'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('link'); ?>"><?php _e("Link:", 'sevenstars'); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('target'); ?>"><?php _e("Open in a new tab", 'sevenstars'); ?></label>
        </p>
        <?php
    }
}
