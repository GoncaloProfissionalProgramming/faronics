			...
			<div class="col-md-12">
				<div class="single-portfolio-title">
					...
					<ul class="portfolio-controls list-inline">
						<li><?php previous_post_link('%link', __('<i class="fa-chevron-left"></i>', 'sevenstars')); ?></li>
						<?php if ($smof_data['portfolio_page'] && $smof_data['portfolio_page'] != 'Select a page:') : ?>
                            <li><a href="<?php echo get_permalink(get_page_by_path($smof_data['portfolio_page'])); ?>"><i class="fa-th"></i></a></li>
                        <?php endif; ?>
						<li><?php next_post_link('%link', __('<i class="fa-chevron-right"></i>', 'sevenstars')); ?></li>
					<?php endif; ?>
					</ul>
				</div>
			</div>
						...
						<div class="content">
							...
							<div class="row">
								<div class="col-md-12 single-content">
									...
									else if( $gallery_field=='' && $video_field=='' && tt_getmeta('hide_featured_image')!='1' ){
										echo "<div class='entry-media'><img src='$featured_image' alt='". get_the_title() ."' /></div>";
									}								
							...
							// Post Comment 
							if (isset($smof_data['port_comment']) && $smof_data['port_comment'] == 1 && $post->comment_status=='open'): ?>
							<div class="row">
								<div class="col-md-12">
