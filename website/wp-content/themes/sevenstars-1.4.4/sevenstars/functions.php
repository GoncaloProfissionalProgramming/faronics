 ...
 * Globals
 */
define('THEMEDOC', 'http://docs.themeton.com/flatter');
...
if (!function_exists('theme_setup')):
    ...
    function theme_setup() {
        register_nav_menus(array(
            'primary' => __('Primary Navigation', 'sevenstars'),
            'top_bar-menu' => __('Top Bar Navigation', 'sevenstars'),
            'mobile-menu' => __('Mobile Navigation (optional)', 'sevenstars'),
            'footer_bar-menu' => __('Footer Navigation', 'sevenstars')
        ));
...
function themeton_theme_after_setup(){
